...
ADD CONSTRAINT `category_fk_parent_id`
...
CREATE TABLE `index_img`  (
  ...
  `product_id` int(11) NULL DEFAULT NULL COMMENT '商品id 商品id',
  `category_id` int(11) NULL DEFAULT NULL COMMENT '商品分类id 商品分类id',
...
CREATE TABLE `product`  (
  `product_id` int(11) NOT NULL COMMENT '商品主键id',
  ...
  FOREIGN KEY (`category_id`) REFERENCES `category`(`category_id`),
  FOREIGN KEY (`root_category_id`) REFERENCES `category`(`category_id`)
...
CREATE TABLE `product_comments`  (
  ...
  `user_id` int(64) NULL DEFAULT NULL COMMENT '评论用户id 用户名须脱敏',
...
CREATE TABLE `product_img`  (
  ...
  `product_id` int(11) NOT NULL COMMENT '商品外键id 商品外键id',
...
CREATE TABLE `user_addr`  (
  `addr_id` int(64) NOT NULL AUTO_INCREMENT COMMENT '地址主键id',
  `user_id` int(64) NOT NULL COMMENT '用户ID',
...
CREATE TABLE `users`  (
  ...
  `user_img` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'img/default.png' COMMENT '头像 头像',
